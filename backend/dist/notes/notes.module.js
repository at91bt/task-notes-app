...
const seed_service_1 = require("../config/seed.service");
...
exports.NotesModule = NotesModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [notes_service_1.NotesService, database_config_service_1.DatabaseConfigService, seed_service_1.SeedService],
    })
], NotesModule);
